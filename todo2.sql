INSERT INTO todos (title, details, priority, created_at, completed_at)
  ...
  VALUES ('Finish Ego is the Enemy', 'Finish the book!', 2, now(), now());
  ...
  VALUES ('Blog', 'Finish Monday blog entry', 4, now(), now());
  VALUES ('Finish daily project!', 'Complete the daily project and then work on previous submissions.', 1, now(), now());
...
SELECT COUNT(completed_at IS NULL) FROM todos WHERE priority = 3;
